...
- [~] Task 6 — Badge overlay window (corner-pinned, repositions, tears down on close) — implemented, compiles; blocked on a crash (see Post-review fixes) until just now, not yet visually confirmed
